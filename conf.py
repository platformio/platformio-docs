...
sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), "_ext"))
...
is_latest = not str(platformio.VERSION[2]).isdigit()
...
# of the sidebar.
# html_logo = '_static/images/platformio-logo.png'
...
latex_documents = [
    ("index", "PlatformIO.tex", "PlatformIO Documentation", "PlatformIO", "manual"),
]
...
man_pages = [("index", "platformio", "PlatformIO Documentation", ["PlatformIO"], 1)]

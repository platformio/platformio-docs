...
.. list-table::
  ...
  * - **RAM**
    - 320KB
  * - **Vendor**
    - `DSTIKE <https://www.tindie.com/products/lspoplove/dstike-d-duino-32-v3/?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``d-duino-32`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:

...
.. list-table::
  ...
  * - **RAM**
    - 320KB
  * - **Vendor**
    - `WEMOS <https://www.wemos.cc?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``wemos_d1_mini32`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:

...
Please use ``mgbot-iotik32b`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
Uploading
---------
MGBOT IOTIK 32B supports the next uploading protocols:
...
Debugging
---------
:ref:`piodebug` currently does not support MGBOT IOTIK 32B board.

...
.. list-table::
  ...
  * - **RAM**
    - 16KB
  * - **Vendor**
    - `SeeedStudio <https://developer.mbed.org/platforms/Seeed-Arch-BLE/?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``seeedArchBLE`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:

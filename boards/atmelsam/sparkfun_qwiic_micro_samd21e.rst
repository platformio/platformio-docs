...
.. list-table::
  ...
  * - **RAM**
    - 32KB
  * - **Vendor**
    - `SparkFun <https://www.sparkfun.com/products/15423?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``sparkfun_qwiic_micro_samd21e`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:

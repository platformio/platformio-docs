...
.. list-table::
  ...
  * - **RAM**
    - 192KB
  * - **Vendor**
    - `Adafruit <https://www.adafruit.com/product/3382?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``adafruit_metro_m4`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:

...
.. _board_heltec-cubecell_cubecell_module_plus:
...
Please use ``cubecell_module_plus`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
board manifest `cubecell_module_plus.json <https://github.com/HelTecAutomation/platform-heltec-cubecell/blob/master/boards/cubecell_module_plus.json>`_. For example,
...
Debugging
---------
:ref:`piodebug` currently does not support Heltec CubeCell-Module Plus (HTCC-AM02) board.

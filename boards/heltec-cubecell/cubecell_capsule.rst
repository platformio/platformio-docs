...
.. _board_heltec-cubecell_cubecell_capsule:
...
board manifest `cubecell_capsule.json <https://github.com/HelTecAutomation/platform-heltec-cubecell/blob/master/boards/cubecell_capsule.json>`_. For example,

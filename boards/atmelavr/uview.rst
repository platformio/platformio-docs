...
.. list-table::
  ...
  * - **RAM**
    - 2KB
  * - **Vendor**
    - `SparkFun <https://www.sparkfun.com/products/12923?utm_source=platformio.org&utm_medium=docs>`__
...
SparkFun MicroView does not have on-board debug probe and **IS NOT READY** for debugging. You will need to use/buy one of external probe listed below.

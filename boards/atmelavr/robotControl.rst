...
.. list-table::
  ...
  * - **RAM**
    - 2.50KB
  * - **Vendor**
    - `Arduino <https://www.arduino.cc/en/Main/Robot?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``robotControl`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
Debugging
---------
:ref:`piodebug` currently does not support Arduino Robot Control board.

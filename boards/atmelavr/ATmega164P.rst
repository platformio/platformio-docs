...
.. list-table::
  ...
  * - **RAM**
    - 1KB
  * - **Vendor**
    - `Microchip <https://www.microchip.com/wwwproducts/en/ATmega164p?utm_source=platformio.org&utm_medium=docs>`__
...
ATmega164P/PA does not have on-board debug probe and **IS NOT READY** for debugging. You will need to use/buy one of external probe listed below.

...
.. list-table::
  ...
  * - **RAM**
    - 512B
  * - **Vendor**
    - `Atmel <http://www.atmel.com/devices/ATTINY841.aspx?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``attiny841`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:

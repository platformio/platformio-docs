...
.. list-table::
  ...
  * - **RAM**
    - 8KB
  * - **Vendor**
    - `Microchip <https://www.microchip.com/wwwproducts/ATmega2560?utm_source=platformio.org&utm_medium=docs>`__
...
ATmega2560 does not have on-board debug probe and **IS NOT READY** for debugging. You will need to use/buy one of external probe listed below.

...
.. list-table::
  ...
  * - **RAM**
    - 1KB
  * - **Vendor**
    - `Microchip <https://www.microchip.com/wwwproducts/en/ATmega8?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``ATmega8`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
Debugging
---------
:ref:`piodebug` currently does not support ATmega8/A board.

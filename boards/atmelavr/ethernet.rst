...
.. list-table::
  ...
  * - **RAM**
    - 2KB
  * - **Vendor**
    - `Arduino <https://www.arduino.cc/en/Main/ArduinoBoardEthernet?utm_source=platformio.org&utm_medium=docs>`__
...
Arduino Ethernet does not have on-board debug probe and **IS NOT READY** for debugging. You will need to use/buy one of external probe listed below.

...
Arduino Pro or Pro Mini ATmega328 (3.3V, 8 MHz) does not have on-board debug probe and **IS NOT READY** for debugging. You will need to use/buy one of external probe listed below.

...
.. list-table::
  ...
  * - **RAM**
    - 2.50KB
  * - **Vendor**
    - `Arduino <https://store.arduino.cc/arduino-industrial-101?utm_source=platformio.org&utm_medium=docs>`__
...
Arduino Industrial 101 does not have on-board debug probe and **IS NOT READY** for debugging. You will need to use/buy one of external probe listed below.

...
.. list-table::
  ...
  * - **RAM**
    - 2.50KB
  * - **Vendor**
    - `Arduino <https://www.arduino.cc/en/Main/ArduinoBoardYun?utm_source=platformio.org&utm_medium=docs>`__
...
Arduino Yun does not have on-board debug probe and **IS NOT READY** for debugging. You will need to use/buy one of external probe listed below.

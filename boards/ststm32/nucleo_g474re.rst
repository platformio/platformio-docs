...
.. list-table::
  ...
  * - **RAM**
    - 128KB
  * - **Vendor**
    - `ST <https://www.st.com/en/evaluation-tools/nucleo-g474re.html?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``nucleo_g474re`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:

...
.. list-table::
  ...
  * - **RAM**
    - 128KB
  * - **Vendor**
    - `RUMBA <https://github.com/Aus3D/RUMBA32?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``rumba32_f446ve`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:

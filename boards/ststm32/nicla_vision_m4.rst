...
.. _board_ststm32_nicla_vision_m4:
...
Please use ``nicla_vision_m4`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
board manifest `nicla_vision_m4.json <https://github.com/platformio/platform-ststm32/blob/master/boards/nicla_vision_m4.json>`_. For example,

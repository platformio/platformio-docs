...
Please use ``disco_g071rb`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
ST STM32G071B Discovery has on-board debug probe and **IS READY** for debugging. You don't need to use/buy external debug probe.

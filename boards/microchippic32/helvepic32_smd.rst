...
.. _board_microchippic32_helvepic32_smd:
...
Please use ``helvepic32_smd`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
board manifest `helvepic32_smd.json <https://github.com/platformio/platform-microchippic32/blob/master/boards/helvepic32_smd.json>`_. For example,

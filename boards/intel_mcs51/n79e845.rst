...
.. list-table::
  ...
  * - **RAM**
    - 512B
  * - **Vendor**
    - `Nuvoton <http://www.nuvoton.com/hq/products/microcontrollers/8bit-8051-mcus/low-pin-count-8051-series/n79e845/?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``n79e845`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
Debugging
---------
:ref:`piodebug` currently does not support Generic N79E845 board.
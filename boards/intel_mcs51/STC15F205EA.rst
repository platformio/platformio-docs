...
.. _board_intel_mcs51_STC15F205EA:
...
Please use ``STC15F205EA`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
You can override default Generic STC15F205EA settings per build environment using
``board_***`` option, where ``***`` is a JSON object path from
board manifest `STC15F205EA.json <https://github.com/platformio/platform-intel_mcs51/blob/master/boards/STC15F205EA.json>`_. For example,
...
Debugging
---------
:ref:`piodebug` currently does not support Generic STC15F205EA board.
...
.. list-table::
  ...
  * - **RAM**
    - 6KB
  * - **Vendor**
    - `Arduino <https://www.arduino.cc/en/Guide/NANOEvery?utm_source=platformio&utm_medium=docs>`__


Configuration
-------------

Please use ``nano_every`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:

...
.. _board_sifive_sparkfun_redboard:
...
board manifest `sparkfun_redboard.json <https://github.com/platformio/platform-sifive/blob/master/boards/sparkfun_redboard.json>`_. For example,

...
.. list-table::
  ...
  * - **RAM**
    - 512B
  * - **Vendor**
    - `Microchip <https://www.microchip.com/wwwproducts/en/ATmega48?utm_source=platformio.org&utm_medium=docs>`__
...
ATmega48/A does not have on-board debug probe and **IS NOT READY** for debugging. You will need to use/buy one of external probe listed below.

...
.. list-table::
  ...
  * - **RAM**
    - 2.50KB
  * - **Vendor**
    - `Arduino <https://www.arduino.cc/en/Main/ArduinoBoardLeonardo?utm_source=platformio.org&utm_medium=docs>`__
...
Arduino Leonardo does not have on-board debug probe and **IS NOT READY** for debugging. You will need to use/buy one of external probe listed below.

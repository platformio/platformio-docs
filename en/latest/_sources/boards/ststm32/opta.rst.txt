...
Please use ``opta`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
board manifest `opta.json <https://github.com/platformio/platform-ststm32/blob/master/boards/opta.json>`_. For example,

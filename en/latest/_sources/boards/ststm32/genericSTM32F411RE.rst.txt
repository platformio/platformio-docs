...
.. list-table::
  ...
  * - **RAM**
    - 128KB
  * - **Vendor**
    - `Generic <https://www.st.com/en/microcontrollers-microprocessors/stm32f411re.html?utm_source=platformio.org&utm_medium=docs>`__


Configuration
-------------

Please use ``genericSTM32F411RE`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
Uploading
---------
STM32F411RE (128k RAM. 512k Flash) supports the following uploading protocols:

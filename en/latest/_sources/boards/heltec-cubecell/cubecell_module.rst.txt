...
.. _board_heltec-cubecell_cubecell_module:
...
board manifest `cubecell_module.json <https://github.com/HelTecAutomation/platform-heltec-cubecell/blob/master/boards/cubecell_module.json>`_. For example,

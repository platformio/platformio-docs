...
.. list-table::
  ...
  * - **RAM**
    - 2KB
  * - **Vendor**
    - `Microchip <https://www.microchip.com/wwwproducts/en/ATmega324p?utm_source=platformio.org&utm_medium=docs>`__
...
ATmega324P does not have on-board debug probe and **IS NOT READY** for debugging. You will need to use/buy one of external probe listed below.

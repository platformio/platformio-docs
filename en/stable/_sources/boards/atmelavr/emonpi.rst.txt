...
.. list-table::
  ...
  * - **RAM**
    - 2KB
  * - **Vendor**
    - `OpenEnergyMonitor <https://github.com/openenergymonitor/emonpi?utm_source=platformio.org&utm_medium=docs>`__
...
OpenEnergyMonitor emonPi does not have on-board debug probe and **IS NOT READY** for debugging. You will need to use/buy one of external probe listed below.

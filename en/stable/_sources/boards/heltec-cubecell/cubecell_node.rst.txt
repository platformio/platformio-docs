...
.. _board_heltec-cubecell_cubecell_node:
...
board manifest `cubecell_node.json <https://github.com/HelTecAutomation/platform-heltec-cubecell/blob/master/boards/cubecell_node.json>`_. For example,
...
Debugging
---------
:ref:`piodebug` currently does not support Heltec CubeCell-1/2AA Node (HTCC-AB02A) board.

...
Please use ``curiosity_nano_4809`` ID for :ref:`projectconf_env_board` option in :ref:`projectconf`:
...
Debugging
---------
:ref:`piodebug` currently does not support Curiosity Nano ATmega4809 board.
